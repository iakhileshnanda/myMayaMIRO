...
logger = get_logger('mayamiro.api.simulation')
    ...
    Request (JSON):
        {
            ...
            "graph_id": "mayamiro_xxxx",    // Optional, if not provided, get from project
...
def generate_profiles():
    ...
    Request (JSON):
        {
            "graph_id": "mayamiro_xxxx",     // Required
