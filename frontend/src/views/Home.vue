      ...
      <section class="hero-section" :style="s.heroSection">
        <div class="hero-left" :style="s.heroLeft">
          <div class="tag-row" :style="s.tagRow">
            <span class="orange-tag" :style="s.orangeTag"
              >Offline Multi-Agent Simulation Engine</span
            >
            <span class="version-text" :style="s.versionText"
              >/ v0.1-preview</span
            >
          </div>
          ...
          <h1 class="main-title" :style="s.mainTitle">
            ...
            <span class="gradient-text" :style="s.gradientText"
              >Predict What Happens Next</span
            >
          </h1>
          ...
          <div class="hero-desc" :style="s.heroDesc">
            <p :style="s.heroDescP">
              ...
              emergent behavior, and find
              <span :style="s.highlightCode">"local optima"</span> in complex
              social dynamics.
            </p>
            <p class="slogan-text" :style="s.sloganText">
              Your data never leaves your machine. The future is simulated
              locally<span :style="s.blinkingCursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section" :style="s.dashboardSection">
        ...
        <div class="left-panel" :style="s.leftPanel">
          ...
          <p class="section-desc" :style="s.sectionDesc">
            Local prediction engine on standby. Upload unstructured data to
          ...
          <div class="metrics-row" :style="s.metricsRow">
            <div class="metric-card" :style="s.metricCard">
              ...
              <div class="metric-label" :style="s.metricLabel">
        ...
        <div class="right-panel" :style="s.rightPanel">
          <div class="console-box" :style="s.consoleBox">
            ...
            <div :style="s.consoleDivider">
              <span :style="s.consoleDividerText">Parameters</span>
            </div>
...
const steps = [
  {
    num: "01",
    title: "Graph Build",
    desc: "Extract reality seeds from your document, build knowledge graph with Neo4j + GraphRAG",
  },
  {
    num: "02",
    title: "Env Setup",
    desc: "Generate agent personas, configure simulation parameters via local Ollama LLM",
  },
  {
    num: "03",
    title: "Simulation",
    desc: "Run multi-agent simulation locally with dynamic memory updates and emergent behavior",
  },
  {
    num: "04",
    title: "Report",
    desc: "ReportAgent analyzes the simulation results and generates a detailed prediction report",
  },
  {
    num: "05",
    title: "Interaction",
    desc: "Chat with any agent from the simulated world or discuss findings with ReportAgent",
  },
];
